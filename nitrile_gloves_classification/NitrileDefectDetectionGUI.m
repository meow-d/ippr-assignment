function NitrileDefectDetectionGUI(varargin)
    ...
    fig = figure('Name', 'Nitrile Glove Defect Detection - Enhanced', 'NumberTitle', 'off', ...
    ...
    uicontrol(col1, 'Style', 'text', 'String', 'Min Boundaries:', ...
        'Units', 'normalized', 'Position', [0.02 0.82 0.45 0.05], ...
        'FontSize', 8, 'BackgroundColor', [0.94 0.94 0.94]);
    
    appData.notWornBoundaries = uicontrol(col1, 'Style', 'edit', ...
        'String', '2', 'Units', 'normalized', 'Position', [0.55 0.82 0.15 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white', 'Callback', @(src,evt) updateParams());
    ...
    uicontrol(col1, 'Style', 'text', 'String', 'Convexity Threshold:', ...
        'Units', 'normalized', 'Position', [0.02 0.60 0.45 0.05], ...
        'FontSize', 8, 'BackgroundColor', [0.94 0.94 0.94]);
    
    appData.improperConvexity = uicontrol(col1, 'Style', 'edit', ...
        'String', '0.82', 'Units', 'normalized', 'Position', [0.55 0.60 0.15 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white', 'Callback', @(src,evt) updateParams());
    ...
    uicontrol(col1, 'Style', 'text', 'String', 'Perimeter/Area Threshold:', ...
        'Units', 'normalized', 'Position', [0.02 0.38 0.45 0.05], ...
        'FontSize', 8, 'BackgroundColor', [0.94 0.94 0.94]);
    
    appData.insideOutRatio = uicontrol(col1, 'Style', 'edit', ...
        'String', '3.5', 'Units', 'normalized', 'Position', [0.55 0.38 0.15 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white', 'Callback', @(src,evt) updateParams());
    ...
    appData.minBlobArea = uicontrol(col2, 'Style', 'edit', ...
        'String', '500', 'Units', 'normalized', 'Position', [0.55 0.82 0.15 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white', 'Callback', @(src,evt) updateParams());
    
    uicontrol(col2, 'Style', 'text', 'String', 'Close Radius:', ...
        'Units', 'normalized', 'Position', [0.02 0.70 0.45 0.05], ...
        'FontSize', 8, 'BackgroundColor', [0.94 0.94 0.94]);
    
    appData.closeRadius = uicontrol(col2, 'Style', 'edit', ...
        'String', '5', 'Units', 'normalized', 'Position', [0.55 0.70 0.15 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white', 'Callback', @(src,evt) updateParams());
    ...
    uicontrol(col3, 'Style', 'text', 'String', 'Ground Truth Label:', ...
        'Units', 'normalized', 'Position', [0.02 0.82 0.45 0.05], ...
        'FontSize', 8, 'BackgroundColor', [0.94 0.94 0.94]);
    
    appData.groundTruth = uicontrol(col3, 'Style', 'popupmenu', ...
        'String', {'Normal', 'Not Worn', 'Improper Roll', 'Inside Out'}, ...
        'Units', 'normalized', 'Position', [0.50 0.82 0.48 0.05], ...
        'FontSize', 9, 'BackgroundColor', 'white');
    
    appData.accuracyDisplay = uicontrol(col3, 'Style', 'text', ...
        'String', 'Correct: 0 | Incorrect: 0 | Accuracy: N/A', ...
        'Units', 'normalized', 'Position', [0.02 0.65 0.96 0.10], ...
        'FontSize', 10, 'FontWeight', 'bold', 'BackgroundColor', [0.96 0.96 0.96], ...
